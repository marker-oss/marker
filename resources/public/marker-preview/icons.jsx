// Icons (Lucide-style, hand-tuned for 16px)
const Icon = ({ name, size = 16, ...rest }) => {
  const paths = {
    home: <><path d="M3 12l9-9 9 9"/><path d="M5 10v10h14V10"/></>,
    pulse: <><path d="M3 12h4l3-9 4 18 3-9h4"/></>,
    finance: <><circle cx="12" cy="12" r="9"/><path d="M9 9h4.5a2 2 0 010 4H10m0 0h3.5a2 2 0 010 4H8"/></>,
    products: <><path d="M3 7l9-4 9 4-9 4-9-4z"/><path d="M3 12l9 4 9-4"/><path d="M3 17l9 4 9-4"/></>,
    warehouse: <><path d="M3 9l9-6 9 6v12H3z"/><path d="M9 22V12h6v10"/></>,
    ...
    sparkles: <><path d="M12 3v18M3 12h18"/></>,
    ...
    download: <><path d="M12 3v12M5 12l7 7 7-7"/><path d="M5 21h14"/></>,
    ...
    edit: <><path d="M11 4H4v16h16v-7"/><path d="M18.5 2.5l3 3L12 15l-4 1 1-4z"/></>,
    ...
    success: <><circle cx="12" cy="12" r="9"/><polyline points="8 12 11 15 16 9"/></>,
    ...
    flame: <><path d="M12 22a7 7 0 007-7c0-3-2-6-4-7 1 4-3 6-3 9 0-2-2-3-2-3 0 2-3 4-3 6a5 5 0 005 5z"/></>,
  };
  return (
